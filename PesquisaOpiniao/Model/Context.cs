...
public class Context : DbContext{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder){
        ...
        // optionsBuilder.UseSqlServer("Data Source = JVLPC0571;" + "Initial Catalog = marketPlace; Integrated Security=True"); bdluisao
    }
    protected override void OnModelCreating(ModelBuilder modelBuilder){
        ...
        modelBuilder.Entity<Adm>(entity =>
        {
            ...
            entity.HasMany(e=>e.Pesquisas).WithOne();
        });
        modelBuilder.Entity<Pesquisa>(entity =>
        {
            entity.HasKey(e=>e.Id);
            entity.Property(e=>e.Codigo).IsRequired();
            entity.HasOne(e=>e.Adm).WithMany();
            entity.HasMany(e=>e.Perguntas).WithOne();
        });
        modelBuilder.Entity<Pergunta>(entity =>
        {
            ...
            entity.HasOne(e=>e.Pesquisa).WithMany();
            entity.HasMany(e=>e.Alternativas).WithOne();
            entity.HasMany(e=>e.Respostas).WithOne();
        });
        modelBuilder.Entity<Resposta>(entity =>
        {
            entity.HasKey(e=>e.Id);
            entity.Property(e=>e.ConteudoResposta).IsRequired();
            entity.HasOne(e=>e.Pergunta).WithMany();
        });
